...
mosi_pin = board.GP11 # SPI1_TX green
clk_pin = board.GP10 # SPI1_SCK yellow
reset_pin = board.GP17 # SPI0_Csn grey
cs_pin = board.GP18 # SPI0_SCK orange
dc_pin = board.GP16 # SPIO_RX blue A0
#VCC to 3V3 Out
#LED- to GND
#LED+ to VBUS via 15ohm
# Jumpers at VCC,RST,A0,SDA,SCL,CS,LED+,LED-
...
cam = OV7670(
    cam_bus,
    data_pins=[  # 7_consec_GPIOs_except_GP28_GP22
        board.GP0,  # grey_column2
        board.GP1,  # orange_column1
        board.GP2,  # purple_colum2
        board.GP3,  # yellow_column1
        board.GP4,  # blue_column2
        board.GP5,  # green_column1
        board.GP6,  # green_column2
        board.GP7,  # blue_column1
    ],
    clock=board.GP8,  # i2c0_SDA purple_column1
    vsync=board.GP13,  # i2c0_SCL grey_column1
    href=board.GP12,  # i2c0_SDA orange_column2
    mclk=board.GP9,  # i2c0_SCL yellow_column2
    shutdown=None,  # i2c1_SCL_white_column2_NC / not attached
    reset=None,  # i2c1_SDA red_column1_NC
)
#GND-Brown_column2
#3V3-Black_column1
